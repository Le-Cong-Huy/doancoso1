...
public class Add extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        dayofbirthtxt = new javax.swing.JTextField();
        ...
        dayofbirthtxt.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
        jPanel1.add(dayofbirthtxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 210, 200, 30));
        ...
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/images/Add.png"))); // NOI18N
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
            ...
            String dateofbirth = dayofbirthtxt.getText();
            ...
            PreparedStatement checkStatement = con.prepareStatement("SELECT `Full Name` FROM thongtinchitiet WHERE `Full Name` = ?");
                PreparedStatement ps = con.prepareStatement("INSERT INTO thongtinchitiet(`Full Name`, `Phone Number`, `Date of Birth`, `Email Address`, `Address`, `Gender`, `Most Favorite Hobby`, `Company`, `Position`, `Dream`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");)
            {
            ...
            ps.setString(7, mostfavoritehobby);
            ps.setString(8, company);
            ps.setString(9, position);
            ps.setString(10, dream);  
            ps.executeUpdate();
    ...
    private javax.swing.JTextField dayofbirthtxt;
